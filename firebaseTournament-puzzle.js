...
const GAME_ID = 'puzzle';  // ← Change pour chaque jeu
const GAME_NAME = 'puzzle';  // ← Change pour chaque jeu
...
function shareJackpot(type) {
  ...
  const shareUrl = `${window.location.origin}/tournaments-home-puzzle.html`;
