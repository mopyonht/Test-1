...
const COTES_CATEGORIES = {
    E: [
        { "1":2.05, "X":3.00, "2":2.05, "1X":1.30, "12":1.28, "X2":1.30, "btts_wi":1.85, "btts_non":1.85, "total":{"<0.5":9.0,"<1.5":4.5,"<2.5":2.0,"<3.5":3.2,">0.5":1.05,">1.5":1.35,">2.5":2.10,">3.5":1.55}, "scoreexact":{"0-0":7.5,"1-0":5.0,"0-1":5.0,"1-1":5.5,"2-0":7.0,"0-2":7.0,"2-1":6.0,"1-2":6.0,"2-2":10.0,"3-0":10.0,"0-3":10.0,"3-1":9.0,"1-3":9.0,"3-2":15.0,"2-3":15.0,"3-3":15.0} },
        { "1":2.10, "X":2.95, "2":2.10, "1X":1.32, "12":1.30, "X2":1.32, "btts_wi":1.80, "btts_non":1.90, "total":{"<0.5":9.5,"<1.5":4.8,"<2.5":2.1,"<3.5":3.0,">0.5":1.04,">1.5":1.30,">2.5":2.00,">3.5":1.60}, "scoreexact":{"0-0":7.0,"1-0":5.2,"0-1":5.2,"1-1":5.8,"2-0":7.2,"0-2":7.2,"2-1":6.2,"1-2":6.2,"2-2":11.0,"3-0":10.5,"0-3":10.5,"3-1":9.5,"1-3":9.5,"3-2":15.0,"2-3":15.0,"3-3":15.0} },
        { "1":2.20, "X":2.90, "2":2.20, "1X":1.28, "12":1.28, "X2":1.28, "btts_wi":1.90, "btts_non":1.80, "total":{"<0.5":8.5,"<1.5":4.2,"<2.5":1.9,"<3.5":3.3,">0.5":1.06,">1.5":1.40,">2.5":2.20,">3.5":1.50}, "scoreexact":{"0-0":8.0,"1-0":4.8,"0-1":4.8,"1-1":5.5,"2-0":6.8,"0-2":6.8,"2-1":5.8,"1-2":5.8,"2-2":10.5,"3-0":11.0,"0-3":11.0,"3-1":9.0,"1-3":9.0,"3-2":15.0,"2-3":15.0,"3-3":15.0} }
    ],
    D1: [
        { "1":1.60, "X":3.20, "2":4.50, "1X":1.15, "12":1.22, "X2":2.10, "btts_wi":2.10, "btts_non":1.65, "total":{"<0.5":10.0,"<1.5":5.0,"<2.5":2.2,"<3.5":2.8,">0.5":1.04,">1.5":1.25,">2.5":1.90,">3.5":1.70}, "scoreexact":{"0-0":9.0,"1-0":4.0,"0-1":7.5,"1-1":6.5,"2-0":5.0,"0-2":11.0,"2-1":5.5,"1-2":9.0,"2-2":13.0,"3-0":6.5,"0-3":15.0,"3-1":7.0,"1-3":15.0,"3-2":13.0,"2-3":15.0,"3-3":15.0} },
        { "1":1.55, "X":3.30, "2":5.00, "1X":1.12, "12":1.20, "X2":2.20, "btts_wi":2.20, "btts_non":1.60, "total":{"<0.5":10.5,"<1.5":5.2,"<2.5":2.3,"<3.5":2.7,">0.5":1.03,">1.5":1.22,">2.5":1.85,">3.5":1.75}, "scoreexact":{"0-0":9.5,"1-0":3.8,"0-1":8.0,"1-1":7.0,"2-0":4.8,"0-2":12.0,"2-1":5.2,"1-2":9.5,"2-2":14.0,"3-0":6.0,"0-3":15.0,"3-1":6.8,"1-3":15.0,"3-2":12.0,"2-3":15.0,"3-3":15.0} },
        { "1":1.65, "X":3.10, "2":4.20, "1X":1.18, "12":1.25, "X2":2.00, "btts_wi":2.00, "btts_non":1.70, "total":{"<0.5":9.5,"<1.5":4.8,"<2.5":2.1,"<3.5":2.9,">0.5":1.05,">1.5":1.28,">2.5":1.95,">3.5":1.65}, "scoreexact":{"0-0":8.5,"1-0":4.2,"0-1":7.0,"1-1":6.0,"2-0":5.2,"0-2":10.5,"2-1":5.8,"1-2":8.5,"2-2":12.0,"3-0":7.0,"0-3":15.0,"3-1":7.5,"1-3":15.0,"3-2":14.0,"2-3":15.0,"3-3":15.0} }
    ],
    D2: [
        { "1":4.50, "X":3.20, "2":1.60, "1X":2.10, "12":1.22, "X2":1.15, "btts_wi":2.10, "btts_non":1.65, "total":{"<0.5":10.0,"<1.5":5.0,"<2.5":2.2,"<3.5":2.8,">0.5":1.04,">1.5":1.25,">2.5":1.90,">3.5":1.70}, "scoreexact":{"0-0":9.0,"1-0":7.5,"0-1":4.0,"1-1":6.5,"2-0":11.0,"0-2":5.0,"2-1":9.0,"1-2":5.5,"2-2":13.0,"3-0":15.0,"0-3":6.5,"3-1":15.0,"1-3":7.0,"3-2":15.0,"2-3":13.0,"3-3":15.0} },
        { "1":5.00, "X":3.30, "2":1.55, "1X":2.20, "12":1.20, "X2":1.12, "btts_wi":2.20, "btts_non":1.60, "total":{"<0.5":10.5,"<1.5":5.2,"<2.5":2.3,"<3.5":2.7,">0.5":1.03,">1.5":1.22,">2.5":1.85,">3.5":1.75}, "scoreexact":{"0-0":9.5,"1-0":8.0,"0-1":3.8,"1-1":7.0,"2-0":12.0,"0-2":4.8,"2-1":9.5,"1-2":5.2,"2-2":14.0,"3-0":15.0,"0-3":6.0,"3-1":15.0,"1-3":6.8,"3-2":15.0,"2-3":12.0,"3-3":15.0} },
        { "1":4.20, "X":3.10, "2":1.65, "1X":2.00, "12":1.25, "X2":1.18, "btts_wi":2.00, "btts_non":1.70, "total":{"<0.5":9.5,"<1.5":4.8,"<2.5":2.1,"<3.5":2.9,">0.5":1.05,">1.5":1.28,">2.5":1.95,">3.5":1.65}, "scoreexact":{"0-0":8.5,"1-0":7.0,"0-1":4.2,"1-1":6.0,"2-0":10.5,"0-2":5.2,"2-1":8.5,"1-2":5.8,"2-2":12.0,"3-0":15.0,"0-3":7.0,"3-1":15.0,"1-3":7.5,"3-2":15.0,"2-3":14.0,"3-3":15.0} }
    ],
    TD1: [
        { "1":1.20, "X":5.50, "2":10.0, "1X":1.05, "12":1.10, "X2":3.20, "btts_wi":3.00, "btts_non":1.35, "total":{"<0.5":11.0,"<1.5":5.5,"<2.5":2.5,"<3.5":2.5,">0.5":1.02,">1.5":1.15,">2.5":1.70,">3.5":1.90}, "scoreexact":{"0-0":12.0,"1-0":3.5,"0-1":12.0,"1-1":9.0,"2-0":4.0,"0-2":15.0,"2-1":4.5,"1-2":15.0,"2-2":15.0,"3-0":5.0,"0-3":15.0,"3-1":6.0,"1-3":15.0,"3-2":15.0,"2-3":15.0,"3-3":15.0} },
        { "1":1.18, "X":6.00, "2":12.0, "1X":1.04, "12":1.08, "X2":3.50, "btts_wi":3.20, "btts_non":1.30, "total":{"<0.5":11.5,"<1.5":5.8,"<2.5":2.6,"<3.5":2.4,">0.5":1.02,">1.5":1.12,">2.5":1.65,">3.5":2.00}, "scoreexact":{"0-0":13.0,"1-0":3.2,"0-1":13.0,"1-1":9.5,"2-0":3.8,"0-2":15.0,"2-1":4.2,"1-2":15.0,"2-2":15.0,"3-0":4.5,"0-3":15.0,"3-1":5.5,"1-3":15.0,"3-2":15.0,"2-3":15.0,"3-3":15.0} },
        { "1":1.22, "X":5.00, "2":9.00, "1X":1.06, "12":1.12, "X2":3.00, "btts_wi":2.80, "btts_non":1.40, "total":{"<0.5":10.5,"<1.5":5.2,"<2.5":2.4,"<3.5":2.6,">0.5":1.03,">1.5":1.18,">2.5":1.75,">3.5":1.80}, "scoreexact":{"0-0":11.0,"1-0":3.8,"0-1":11.0,"1-1":8.5,"2-0":4.2,"0-2":15.0,"2-1":5.0,"1-2":15.0,"2-2":15.0,"3-0":5.5,"0-3":15.0,"3-1":6.5,"1-3":15.0,"3-2":15.0,"2-3":15.0,"3-3":15.0} }
    ],
    TD2: [
        { "1":10.0, "X":5.50, "2":1.20, "1X":3.20, "12":1.10, "X2":1.05, "btts_wi":3.00, "btts_non":1.35, "total":{"<0.5":11.0,"<1.5":5.5,"<2.5":2.5,"<3.5":2.5,">0.5":1.02,">1.5":1.15,">2.5":1.70,">3.5":1.90}, "scoreexact":{"0-0":12.0,"1-0":12.0,"0-1":3.5,"1-1":9.0,"2-0":15.0,"0-2":4.0,"2-1":15.0,"1-2":4.5,"2-2":15.0,"3-0":15.0,"0-3":5.0,"3-1":15.0,"1-3":6.0,"3-2":15.0,"2-3":15.0,"3-3":15.0} },
        { "1":12.0, "X":6.00, "2":1.18, "1X":3.50, "12":1.08, "X2":1.04, "btts_wi":3.20, "btts_non":1.30, "total":{"<0.5":11.5,"<1.5":5.8,"<2.5":2.6,"<3.5":2.4,">0.5":1.02,">1.5":1.12,">2.5":1.65,">3.5":2.00}, "scoreexact":{"0-0":13.0,"1-0":13.0,"0-1":3.2,"1-1":9.5,"2-0":15.0,"0-2":3.8,"2-1":15.0,"1-2":4.2,"2-2":15.0,"3-0":15.0,"0-3":4.5,"3-1":15.0,"1-3":5.5,"3-2":15.0,"2-3":15.0,"3-3":15.0} },
        { "1":9.00, "X":5.00, "2":1.22, "1X":3.00, "12":1.12, "X2":1.06, "btts_wi":2.80, "btts_non":1.40, "total":{"<0.5":10.5,"<1.5":5.2,"<2.5":2.4,"<3.5":2.6,">0.5":1.03,">1.5":1.18,">2.5":1.75,">3.5":1.80}, "scoreexact":{"0-0":11.0,"1-0":11.0,"0-1":3.8,"1-1":8.5,"2-0":15.0,"0-2":4.2,"2-1":15.0,"1-2":5.0,"2-2":15.0,"3-0":15.0,"0-3":5.5,"3-1":15.0,"1-3":6.5,"3-2":15.0,"2-3":15.0,"3-3":15.0} }
    ]
};
...
function getCotesForMatch(match) {
    if (match.cotes) return match.cotes;
    const cat = match.cat;
    if (!cat || !COTES_CATEGORIES[cat]) return {};
    const pool = COTES_CATEGORIES[cat];
    const seed = match.id.split('').reduce((acc, c) => acc + c.charCodeAt(0), 0);
...
function getMultiplicateurMatch(matchId, type, value) {
    ...
    if (!match) return 1;
    const cotes = getCotesForMatch(match);

    if (type === 'resultat')     return cotes[value] || 1;
    if (type === 'doublechance') return cotes[value] || 1;
    if (type === 'btts')         return value === 'Wi' ? (cotes.btts_wi || 2.1) : (cotes.btts_non || 1.6);
    if (type === 'total')        return cotes.total?.[value] || 1;
    if (type === 'scoreexact')   return cotes.scoreexact?.[value] || 1;
    return 1;
}
...
async function loadActiveTournament() {
    ...
    try {
        ...
        cachedTournaments = snap.docs.map(d => ({ id: d.id, ...d.data() }));
...
async function refreshTournoiSpots() {
    ...
    for (const [key, config] of Object.entries(TOURNOI_CONFIG)) {
        ...
        if (cachedTournaments && (Date.now() - tournamentsCacheTime) < TOURNAMENTS_CACHE_TTL) {
            const data = cachedTournaments.find(t => t.type === config.type);
            if (!data) {
            ...
            const remaining = config.maxParticipants - (data.participantCount || 0);
            if (spotsEl) spotsEl.textContent = `${remaining} plas lib`;
            if (statusEl) statusEl.innerHTML = `<span class="status-dot-small"></span> ${data.participantCount || 0}/${config.maxParticipants}`;
            continue;
        }

        // ✅ Cache expiré — lecture Firestore en dernier recours
        try {
            const snap = await window.firebaseApp.db
            ...
            if (snap.empty) {
                ...
                const taken = data.participantCount || 0;
            ...
            console.error('Erreur refresh spots:', e);
        }
    }
}
...
const tournoiData = cached;
    ...
    if (taken >= config.maxParticipants) {
        showToast('⚠️ Tounwa sa plen — eseye lòt la');
        return;
    }
