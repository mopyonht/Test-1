...
function updatePanier() {
    ...
    if (count === 0) {
        ...
        if (pl) pl.textContent = '0 / 18 match';
    ...
    if (progressBar) progressBar.style.width = (count / 18 * 100) + '%';
    if (progressLabel) progressLabel.textContent = count + ' / 18 match';
...
window.confirmAndSubmitFiche = async function() {
    ...
    if (Object.keys(userChoices).length < 18) {
    showToast('❌ Vérification échouée : 18 choix requis');
    return;
}
    ...
    overlay.innerHTML = `
        <div class="free-sub-card">
            ...
            <div class="free-sub-features">
                ...
                <div class="free-sub-feature">
                    <span>⚽</span>
                    <span>Chwazi 18 match epi fè prediksyon ou</span>
                </div>
                <div class="free-sub-feature">
                    <span>🏆</span>
